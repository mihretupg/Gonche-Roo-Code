...
const INTENT_ID_PARAMETER_DESCRIPTION = `Active intent identifier selected earlier via select_active_intent (for example: INT-001).`
const MUTATION_CLASS_PARAMETER_DESCRIPTION = `Semantic mutation class for this write. Must be AST_REFACTOR (intent preserved) or INTENT_EVOLUTION (new feature / intent expansion).`
