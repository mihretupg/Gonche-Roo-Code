...
2.1. If the task may mutate workspace state (file edits, patches, or destructive commands), call \`select_active_intent(intent_id)\` as the first tool action before any mutation.
